...
class GestaltUIPage extends React.Component {
    constructor(props) {
    super(props);
    this.state = { checked: true, open: false, showLayer: false, isOpen: false, sm: false, md: false, lg: false, showModal: false, isPulsing: true,activeIndex: 0,showConfirmationToast: false, clicks: 0};
